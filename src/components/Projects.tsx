...
import { projects, projtitle } from "../constants";
    ...
    return ( 
        <div>
            ...
            <div className="flex justify-center items-center mt-8">
                <p className={`${isLight ? "text-black" : "text-white"} text-lg`}>
                    To see more projects of mine, check out my 
                    <a 
                        href="https://github.com/AirajHussain" 
                        target="_blank" 
